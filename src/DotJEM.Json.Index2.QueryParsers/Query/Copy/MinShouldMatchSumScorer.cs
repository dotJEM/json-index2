...
namespace DotJEM.Json.Index2.QueryParsers.Query.Copy
{
    ...
    /// </summary>
    internal class CopyOfMinShouldMatchSumScorer : Scorer
    {
        /// <summary>
        ...
        public CopyOfMinShouldMatchSumScorer(Weight weight, IList<Scorer> subScorers, int minimumNrMatchers)
            : base(weight)
        {
            ...
            ArrayUtil.TimSort(sortedSubScorers, System.Collections.Generic.Comparer<Scorer>.Create((o1, o2) => (o2.GetCost() - o1.GetCost()).Signum()));
        ...
        /// </summary>
        public CopyOfMinShouldMatchSumScorer(Weight weight, IList<Scorer> subScorers)
