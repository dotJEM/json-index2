...
namespace DotJEM.Json.Index.Results
{
    ...
    public sealed class Search : ISearch
    {
        ...
        public IInfoStream EventInfoStream { get; } = new InfoStream<Search>();
        ...
        public Search(IIndexSearcherManager manager, IInfoStream eventInfo, Query query = null, int skip = 0, int take = 25, Sort sort = null, Filter filter = null, bool doDocScores = true, bool doMaxScores = true)
        {
